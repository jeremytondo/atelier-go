...
// isSystemdServiceActive checks if the systemd service is active
func isSystemdServiceActive() bool {
	cmd := exec.Command("systemctl", "--user", "is-active", "atelier-go")
	err := cmd.Run()
